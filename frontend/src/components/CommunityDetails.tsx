  ...
  return (
    <section>
      <div className="community-details-container">
        ...
        <dl className="community-info-container">
          ...
          <div className="community-info-line">
            <dt className="community-info-line-label">
              <RiGitRepositoryPrivateLine size={20} /> <span>Privacidade</span>
            </dt>
            <dd className="community-info-line-value">
              <span>Público</span>
            </dd>
          ...
          <div className="community-info-line">
            <dt className="community-info-line-label">
              <LiaGlobeAmericasSolid size={20} /> <span>Proprietário</span>
            </dt>
            <dd className="community-info-line-value">
          ...
          <div className="community-info-line">
            <dt className="community-info-line-label">
              <FaShieldHalved size={20} /> <span>Moderadores</span>
            </dt>
            <dd className="community-info-line-value">
